var Flood = new Phaser.Class({
  ...
  preload: function () {
    ...
    this.load.bitmapFont('atari', 'bitmap/atari-smooth.png', 'bitmap/atari-smooth.xml');
    this.load.atlas('flood', 'blobs.png', 'blobs.json');
  },
  create: function () {
    ...
    //В игре используется сетка 14x14 6 разных цветов.
    ...
    //Сделайте несколько наводнений, чтобы было немного легче начать
