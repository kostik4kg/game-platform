export default class MainGame extends Phaser.Scene {
  ...
  create(){
    ...
    // Создайте группу, выровненную по сетке 4x4, чтобы удерживать наши спрайты.
  ...
  arrangeGrid() {
    // Нам нужно убедиться, что в сетке есть только одна пара
    // Создадим массив со всеми возможными кадрами в нем:
    let frames = Phaser.Utils.Array.NumberArray(1, 40);
    let selected = Phaser.Utils.Array.NumberArray(0, 15);
    let children = this.emojis.getChildren();
    // Теперь мы выбираем 16 случайных значений, удаляя каждое из массива, чтобы мы не могли выбрать его снова
    // и вставляем их в спрайты
    for (let i = 0; i < 16; i++) {
